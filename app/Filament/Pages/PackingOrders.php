...
class PackingOrders extends Page implements HasTable
{
    use InteractsWithTable;

    protected static string $view = 'filament.pages.packing-orders';

    protected static ?string $title = 'Chalan';
    protected static ?string $navigationLabel = 'Chalan';
    protected static ?string $navigationGroup = 'Orders';
    protected static ?string $navigationIcon = 'heroicon-o-cube'; // optional
    protected static ?int $navigationSort = 3;

    public function table(Table $table): Table
    {
        return $table
                ->query(Order::query()->where('mainstatus', 'approved')->where('clnstatus', 'packing'))
    ...
    {
        return (string) Order::where('mainstatus', 'approved')->where('clnstatus', 'packing')->count();
    }
